package server;//package stdDraw;
// https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java.html
/******************************************************************************
 *  Compilation:  javac server.StdDraw.java
 *  Execution:    java server.StdDraw
 *  Dependencies: none
 *
 *
 ...
 */
/**
 *  The {@code server.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code server.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">server.StdDraw.java</a>
 ...
 *           server.StdDraw.setPenRadius(0.05);
 *           server.StdDraw.setPenColor(server.StdDraw.BLUE);
 *           server.StdDraw.point(0.5, 0.5);
 *           server.StdDraw.setPenColor(server.StdDraw.MAGENTA);
 *           server.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code server.StdDraw.line()} and {@code server.StdDraw.point()}
 *  draw lines and points; the methods {@code server.StdDraw.setPenRadius()}
 *  and {@code server.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code server.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   server.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code server.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code server.StdDraw.setPenColor(server.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code server.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code server.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   server.StdDraw.setFont(font);
 *   server.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code server.StdDraw.clear(server.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   server.StdDraw.setScale(-2, +2);
 *   server.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       server.StdDraw.clear();
 *       server.StdDraw.filledCircle(x, y, 0.05);
 *       server.StdDraw.filledCircle(-x, -y, 0.05);
 *       server.StdDraw.show();
 *       server.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code server.StdDraw.BLACK}, {@code server.StdDraw.BLUE}, {@code server.StdDraw.CYAN},
	 * {@code server.StdDraw.DARK_GRAY}, {@code server.StdDraw.GRAY}, {@code server.StdDraw.GREEN},
	 * {@code server.StdDraw.LIGHT_GRAY}, {@code server.StdDraw.MAGENTA}, {@code server.StdDraw.ORANGE},
	 * {@code server.StdDraw.PINK}, {@code server.StdDraw.RED}, {@code server.StdDraw.WHITE}, and
	 * {@code server.StdDraw.YELLOW}.
	 *
	...
	private static Image getImage(String filename) {
		...
		// in case file is inside a .jar (classpath relative to server.StdDraw)
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to server.StdDraw)
        try {
            URL url = server.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
	...
	public void mousePressed(MouseEvent e) {
		...
		//server.StdDraw.ellipse(0.3, 0.5, 0.1, 0.2);
		//server.StdDraw.clear();
		StdDraw.draw();
	}
